...
function ProjectLogo({ project, isActive, size }) {
  ...
  const h = size === 'large' ? (isVideo ? 'clamp(385px, 70vh, 735px)' : 'clamp(300px, 60vh, 500px)') : isVideo ? 'clamp(300px, 50vh, 550px)' : project.id === 'djamao' ? 'clamp(80px, 14vw, 140px)' : 'clamp(60px, 12vw, 90px)'
