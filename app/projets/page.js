...
function ProjectLogo({ project, isActive, size }) {
  ...
  const w = size === 'large' ? (isVideo ? '100%' : '80%') : isVideo ? '100%' : project.id === 'djamao' ? '100px' : '66px'
  const h = size === 'large' ? (isVideo ? '750px' : '400px') : isVideo ? '500px' : project.id === 'djamao' ? '110px' : '72px'
  ...
  const containerStyle = {
    ...
    position: 'relative',
    transform: inactiveShift ?? (!isVideo && project.id === 'djamao' ? (size !== 'large' ? 'translateY(-8px)' : 'translateY(-20px)') : undefined),
  }
      ...
      <div style={containerStyle}>
        ...
        <div style={{ position: 'relative', width: '100%', height: '100%', transform: blockShift }}>
          <video
            ...
            muted
            playsInline
            style={{ width: '100%', height: '100%', objectFit: 'contain', transform: 'translate(1.5px, -1px)' }}
          >
